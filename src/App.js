        ...
        {todoList.map((task) => {
          return( 
            <div className="flex justify-center items-center gap-3">
                <h1 className={`font-semibold text-[27px] my-2 ${task.completed? "bg-green-400" : "bg-slate-300"} rounded-md w-[320px] sm:w-[400px] pl-3 py-1 italic flex items-center`}>
